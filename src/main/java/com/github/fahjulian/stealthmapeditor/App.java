...
public class App extends AbstractApp
{
    ...
    protected AbstractScene onInit()
    {
        ...
        // .showInputDialog("Enter the filepath to the map you want to edit. Leave blank
        // for a new map.");
        ...
        // map = TileMap.create(BASE_DIR + "export/new_map.xml", width, height,
        // tileSize, posZ,
        ...
        TileMap map = ResourcePool.getOrLoadResource(TileMap.fromFile(RESOURCE_DIR + "maps/example_map.xml"));
        return new MapEditorScene(map);
    }

    public static void main(String... args)
    {
        new App("Stealth Map Editor", 1920 / 2, 1015 / 2).run();
    }
}
